...
from VideoAI.views import create_video, text_input_view, text_view, image_view, register_request, login_request, upload_image
...
urlpatterns = [
    ...
    path('VideoAI/download/', create_video, name='download-video')
]
